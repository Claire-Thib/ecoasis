function but1(){
  document.getElementById('therm1').style = 'display:block';
  document.getElementById('therm2').style = 'display:none';
  document.getElementById('therm3').style = 'display:none';
  document.getElementById('therm4').style = 'display:none';
  document.getElementById('therm5').style = 'display:none';
  document.getElementById('therm6').style = 'display:none';
...
function but3(){
  document.getElementById('therm1').style = 'display:none';
  document.getElementById('therm2').style = 'display:none';
  document.getElementById('therm3').style = 'display:block';
  document.getElementById('therm4').style = 'display:none';
  document.getElementById('therm5').style = 'display:none';
  document.getElementById('therm6').style = 'display:none';
  document.getElementById('none').style.display='none';
...
function but4(){
  ...
  document.getElementById('therm2').style = 'display:none';
  document.getElementById('therm3').style = 'display:none';
  document.getElementById('therm4').style = 'display:block';
  document.getElementById('therm5').style = 'display:none';
  document.getElementById('therm6').style = 'display:none';
  document.getElementById('none').style.display='none';
  document.getElementById('one').style.display='none';
...
function but5(){
  ...
  document.getElementById('therm3').style = 'display:none';
  document.getElementById('therm4').style = 'display:none';
  document.getElementById('therm5').style = 'display:block';
  document.getElementById('therm6').style = 'display:none';
  document.getElementById('none').style.display='none';
  document.getElementById('one').style.display='none';
  document.getElementById('two').style.display='none';
...
function but6(){
  ...
  document.getElementById('therm4').style = 'display:none';
  document.getElementById('therm5').style = 'display:none';
  document.getElementById('therm6').style = 'display:block';
  document.getElementById('none').style.display='none';
  document.getElementById('one').style.display='none';
  document.getElementById('two').style.display='none';
  document.getElementById('four').style.display='none';
